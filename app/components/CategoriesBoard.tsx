// ===== File: components/CategoriesBoard.tsx =====
import { Megaphone, Utensils, Sparkles, Flower2, Gift, Plane, Car, Monitor, Home, ShoppingBag, Gem, Dumbbell, CalendarDays, Palette } from "lucide-react";
...
function Row({ items }: { items: { label: string; Icon: any; color: string }[] }) {
return (
